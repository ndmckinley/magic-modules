...
bundle exec compiler -v beta -p products/compute -t Address,GlobalAddress,Subnetwork,ForwardingRule,RegionDisk -e terraform -o "${GOPATH}/src/github.com/terraform-providers/terraform-provider-google/"
